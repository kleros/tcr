...
/**
 *  @title AddressTCR
 *  This contract is an arbitrable token curated registry for addresses, sometimes referred to as a Address TCR. Users can send requests to register or remove addresses from the registry, which can in turn, be challenged by parties that disagree with them.
 ...
 */
contract AddressTCR is PermissionInterface, IArbitrable {
